...
const navItems: NavItem[] = [
  ...
  { label: 'Shuttle Routes', href: '/dashboard/shuttle', icon: 'M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0zM13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10M13 8h6a1 1 0 011 1v3l-2.5 3H13', roles: ['STUDENT', 'LECTURER'] },
  ...
  { label: 'Manage Shuttles', href: '/admin/shuttle', icon: 'M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0zM13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10M13 8h6a1 1 0 011 1v3l-2.5 3H13', roles: ['ADMIN'] },
