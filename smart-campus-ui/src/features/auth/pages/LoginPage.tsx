    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-[13px] text-gray-400 whitespace-nowrap">or continue with email</span>
          <div className="flex-1 h-px bg-gray-200" />
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button type="button" className="text-xs font-semibold text-campus-600 hover:text-campus-500 transition-colors">
                Forgot password?
              </button>
            </div>
            <div className="relative">
        ...
        <div className="pt-6 border-t border-gray-100">
          ...
          <p className="text-center text-[10px] text-gray-300 mt-3 tracking-wider uppercase">
            &copy; {new Date().getFullYear()} Smart Campus &bull; Institutional System
          </p>
        </div>
      </div>
    </AuthLayout>
